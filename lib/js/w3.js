...
(function() {
	...
	if(detectmob()) {
		document.getElementById("homebtn").ontouchstart = function() {
			this.className += " w3-hover-black w3-hover-text-white"; 
		};
		document.getElementById("homebtn").ontouchend = function() {
			this.className = this.className.replace(" w3-hover-black w3-hover-text-white", ""); 
		};
		document.getElementById("menubtn").ontouchstart = function() {
			this.className += " w3-hover-black w3-hover-text-white"; 
		};
		document.getElementById("menubtn").ontouchend = function() {
			this.className = this.className.replace(" w3-hover-black w3-hover-text-white", ""); 
		};
	}
})();
